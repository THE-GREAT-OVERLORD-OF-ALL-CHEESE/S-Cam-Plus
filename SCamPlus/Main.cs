using CheeseMods.SCamPlus.CameraModes;
using HarmonyLib;
...
namespace CheeseMods.SCamPlus
{
    ...
    public class SCamPlus : VtolMod
    {
       ...
       // public UnityAction<float> aceMinFov_changed;
        ...
        public static float aceMaxDistance = Mathf.Tan((90 - aceFovRange.min) * Mathf.Deg2Rad) * 30;
        ...
        public void Awake()
        {
            Debug.Log("Cheese's S-Cam+: Hello there!");
        ...
        */
        ...
        {
            Debug.Log("Cheese's S-Cam+: Nothing to unload!");
        }
    }
}